...
import sty from "./PlasmicButton.module.css"; // plasmic-import: VwRr7LFj5ab0/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: s6Wr7mX8NviM/icon
      ...
      >
        ...
        {(hasVariant($state, "withIcons", "withSuffixIcon") ? true : false)
          ? renderPlasmicSlot({
              defaultContents: (
                <IconIcon
                  className={classNames(projectcss.all, sty.svg___8WaAw)}
                  role={"img"}
                />
              ),
