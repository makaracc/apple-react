...
import sty from "./PlasmicProductDisplay.module.css"; // plasmic-import: YWzY6ZdUIWGZ/css
...
function PlasmicProductDisplay__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__tLlL)}>
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img___3RCvw, {
            [sty.imgdark___3RCvWxHxNv]: hasVariant($state, "dark", "dark"),
            [sty.imgisMobileView___3RCvWgeHia]: hasVariant(
              $state,
              "isMobileView",
              "isMobileView"
            )
        ...
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__gKwM8, {
            [sty.imgisMobileView__gKwM8GeHia]: hasVariant(
              $state,
              "isMobileView",
              "isMobileView"
            )
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__tB8J9, {
          [sty.freeBoxreverse__tB8J9Ofs7R]: hasVariant(
            $state,
            "reverse",
            "reverse"
          )
      ...
      >
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___6BujQ, {
            [sty.freeBoxdark___6BujQxHxNv]: hasVariant($state, "dark", "dark")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                <Button
                  className={classNames("__wab_instance", sty.button__p1EDk)}
                  iconLeft={
                    <Icon6Icon
                      className={classNames(projectcss.all, sty.svg__kjnhX)}
                      role={"img"}
                    />
                  }
                  size={"large"}
                ...
                <Button
                  className={classNames("__wab_instance", sty.button__lvOhl)}
                  iconLeft={
                    <Icon6Icon
                      className={classNames(projectcss.all, sty.svg__jof9G)}
                      role={"img"}
                    />
                  }
                  size={"large"}
